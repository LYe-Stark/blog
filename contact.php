...
<body>
    ...
    <header class="masthead" style="background-image:url('/assets/img/contact-bg.jpg?h=1683d68fadc4673ed0357866ae18fbab');">
        <div class="overlay"></div>
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-lg-8 mx-auto">
                    <div class="site-heading">
                        <h1>Contactez-nous</h1><span class="subheading">Des questions ? J'ai vos réponses !</span></div>
                </div>
            </div>
        </div>
    </header>
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-lg-8 mx-auto">
                <p>Aviez-vous des questions à nous poser ? Envoyez les&nbsp; messages nous vous répondrons dans quelques minutes si possible !</p>
                <form id="contactForm" name="sentMessage" novalidate="novalidate">
                    ...
                    <div id="success"></div>
                    <div class="form-group"><button class="btn btn-primary" id="sendMessageButton" type="submit">Envoyez</button></div>
                </form>
            </div>
        </div>
    </div>
